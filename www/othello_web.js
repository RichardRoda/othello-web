/* @ts-self-types="./othello_web.d.ts" */
...
export class OthelloGame {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        OthelloGameFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_othellogame_free(ptr, 0);
    }
    /**
    ...
    get_board() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.othellogame_get_board(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    get_current_player() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.othellogame_get_current_player(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_game_state() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.othellogame_get_game_state(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_score() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.othellogame_get_score(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get_valid_moves() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.othellogame_get_valid_moves(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get_winner() {
        const ret = wasm.othellogame_get_winner(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    make_move(row, col) {
        const ret = wasm.othellogame_make_move(this.__wbg_ptr, row, col);
        if (ret[1]) {
     ...
     */
    constructor() {
        const ret = wasm.othellogame_new();
        this.__wbg_ptr = ret;
        OthelloGameFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    to_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.othellogame_to_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) OthelloGame.prototype[Symbol.dispose] = OthelloGame.prototype.free;
 ...
 * @returns {number}
 */
export function get_ai_move(game_json, depth, row, col, alpha) {
    const ptr0 = passStringToWasm0(game_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_ai_move(ptr0, len0, depth, row, col, alpha);
    return ret;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./othello_web_bg.js": import0,
    };
}

const OthelloGameFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_othellogame_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('othello_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
